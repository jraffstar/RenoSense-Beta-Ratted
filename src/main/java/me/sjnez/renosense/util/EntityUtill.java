...
public class EntityUtill
    ...
    public static boolean isntValid(Entity entity, double range) {
        return entity == null || EntityUtill.isDead(entity) || entity.equals(EntityUtill.mc.player) || entity instanceof EntityPlayer && RenoSense.friendManager.isFriend(entity.getName()) || EntityUtill.mc.player.getDistanceSq(entity) > MathUtil.square(range);
    }
    ...
    public static Map<String, Integer> getTextRadarPlayers() {
        ...
        for (EntityPlayer player : EntityUtil.mc.world.playerEntities) {
            ...
            output.put(healthSB.toString() + " " + (RenoSense.friendManager.isFriend(player) ? "\u00a7b" : "\u00a7r") + player.getName() + " " + distanceSB.toString() + " " + "\u00a7f" + RenoSense.totemPopManager.getTotemPopString(player) + RenoSense.potionManager.getTextRadarPotion(player), (int) EntityUtil.mc.player.getDistance(player));
