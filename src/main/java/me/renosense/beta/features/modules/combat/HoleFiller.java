...
import me.renosense.beta.util.BlockUtill;
...
public class HoleFiller extends Module {
    ...
    public void onEnable() {
        if (RenoSense.moduleManager.isModuleEnabled("AutoCrystal") || RenoSense.moduleManager.isModuleEnabled("OyVeyAutoCrystal")) {
            this.caOn = true;
        }
        super.onEnable();
    }
    ...
    private void findClosestTarget() {
        ...
        for (final EntityPlayer target : playerList) {
            if (target != HoleFiller.mc.player && !RenoSense.friendManager.isFriend(target.getName()) && EntityUtil.isLiving(target)) {
