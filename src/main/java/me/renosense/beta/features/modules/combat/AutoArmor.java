...
public class AutoArmor extends Module {
    ...
    public void onTick() {
        ...
        if (this.timer.passedMs((int) ((float) this.delay.getValue().intValue() * RenoSense.serverManager.getTpsFactor()))) {
            if (!this.taskList.isEmpty()) {
