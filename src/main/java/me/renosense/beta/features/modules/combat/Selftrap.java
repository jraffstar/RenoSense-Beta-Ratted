...
import me.renosense.beta.util.BlockUtil;
import me.renosense.beta.util.EntityUtil;
import me.renosense.beta.util.InventoryUtil;
...
public class Selftrap extends Module {
    ...
    private final me.renosense.beta.util.Timer offTimer = new me.renosense.beta.util.Timer();
    private final me.renosense.beta.util.Timer timer = new me.renosense.beta.util.Timer();
    private final Map<BlockPos, Integer> retries = new HashMap<BlockPos, Integer>();
    private final me.renosense.beta.util.Timer retryTimer = new Timer();
