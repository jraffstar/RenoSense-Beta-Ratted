...
import me.renosense.beta.event.events.DeathEvent;
...
import me.renosense.beta.features.modules.combat.AutoCrystal;
import me.renosense.beta.features.setting.Setting;
import me.renosense.beta.manager.FileManager;
import me.renosense.beta.util.MathUtil;
...
public class AutoGG
    ...
    public String getRandomMessage() {
        ...
        if (this.messages.size() == 0) {
            return "!p died to RenoSense! better luck next time!";
        }
    ...
    public void announceDeath(EntityPlayer target) {
        AutoGG.mc.player.connection.sendPacket(new CPacketChatMessage((this.greentext.getValue() != false ? ">" : "") + this.getRandomMessage().replaceAll("!p", target.getDisplayNameString())));
    }
}