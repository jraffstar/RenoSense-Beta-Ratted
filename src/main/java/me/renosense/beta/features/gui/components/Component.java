package me.renosense.beta.features.gui.components;
...
import me.renosense.beta.features.gui.components.items.Item;
import me.renosense.beta.features.gui.components.items.buttons.Button;
...
public class Component
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        RenoSense.textManager.drawStringWithShadow(this.getName(), (float) this.x + 3.0f, (float) this.y - 4.0f - (float) OyVeyGui.getClickGui().getTextOffset(), -1);
        if (this.open) {
